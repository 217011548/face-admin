  ...
  >
    <div slot="body">
      <el-form ref="form" :model="data.form" label-width="120px">
        ...
        <div>
          <el-form-item label="Ssername：" prop="username">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        username: [{ required: true, message: "Please insert the username", trigger: "blur" }],
        password: [{ required: true, message: "Please insert the password", trigger: "blur" }],
        nickname: [
          { required: true, message: "Please insert the username", trigger: "blur" },
        ],
        phone: [{ required: true, message: "Please insert the phone", trigger: "blur" }],
      },
    };
  },
  methods: {
